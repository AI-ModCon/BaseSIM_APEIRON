...
## What `main.py` Does
- Builds the `CNN` model defined in `model.py`, a cross-entropy loss, and an Adam optimizer.
...
- Computes sensitivity scores with `util.return_score` after each task; you can repurpose these values for analysis or adaptive triggers.
