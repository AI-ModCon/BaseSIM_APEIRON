...
def get_cifar10_train(root: str = "./data", normalize: bool = True) -> datasets.CIFAR10:
    return datasets.CIFAR10(
        root, train=True, download=True, transform=_base_tf(normalize)
    )


def get_cifar10_val(root: str = "./data", normalize: bool = True) -> datasets.CIFAR10:
    # Standard CIFAR-10 test split used as validation
    return datasets.CIFAR10(
