...
REPO=/lustre/orion/lrn097/scratch/asvillar/src/BaseSIM_APEIRON
...
export PYTHONPATH="/lustre/orion/lrn097/proj-shared/fusionMT/MATEY:$REPO/src:$REPO:${PYTHONPATH:-}"
